...
<div class="imgRoll" style="padding-top:20px; width: 100%">
         ...
         <img class="mySlides" src={{ URL::asset('/img/frasers/northRyde/T3.png') }}  style="width:100%">
...
<h1 style="padding-left:30%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Frasers: </span>North Ryde</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">centrale connected urban living</h2>
                </div>
							</div>
						</div>
...
<img src={{ URL::asset('/img/frasers/northRyde/p2.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p3.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p5.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p6.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p7.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p8.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p9.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p10.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p11.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/frasers/northRyde/p12.png') }}>
</div>
...
<a href="{{ asset('documents/frasers/northRyde/BuildingC&DFloorplates.pdf') }}" target="_blank">Building C & D Floorplates.pdf</a>
<br>
<a href="{{ asset('documents/frasers/northRyde/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
<br>
<a href="{{ asset('documents/frasers/northRyde/3Bed.pdf') }}" target="_blank">3 Bed.pdf</a>
   </div>
