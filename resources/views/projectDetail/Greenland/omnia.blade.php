...
<div class="w3-content w3-display-container" style="max-width:100%">
 <div class="imgRoll" style="padding-top:20px; width: 100%">
  ...
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T2.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T3.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T4.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T5.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T6.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/omnia/T7.jpg') }} style="width:100%">
...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Greenland: </span>Omnia-potts point NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">a new point of view</h2>
                </div>
							</div>
						</div>
...
<img src={{ URL::asset('/img/greenland/omnia/p1.png') }}>
<hr class="new1">
</div>
  <div class="w3-content w3-display-container" style="padding-top: 30px;">
	<img src={{ URL::asset('/img/greenland/omnia/p2.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p3.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p4.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p5.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p6.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p7.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p8.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p9.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p10.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p11.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p12.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p13.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p14.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p15.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p16.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p17.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p18.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p19.png') }}>
	<hr class="new1">
	<img src={{ URL::asset('/img/greenland/omnia/p20.png') }}>
...
<a href="{{ asset('documents/greenland/omnia/Floorplates.pdf') }}" target="_blank">Building Map.pdf</a>
<br>
  <a href="{{ asset('documents/greenland/omnia/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
  <br>
  <a href="{{ asset('documents/greenland/omnia/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>   </div>
