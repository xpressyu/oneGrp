...
<div class="w3-content w3-display-container" style="max-width:100%">
 ...
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T2.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T3.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T4.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T5.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T6.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/greenland/nbh/T7.jpg') }} style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Greenland: </span>NBH-lachlan’s line NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">naturally better here </h2>
                </div>
							</div>
						</div>
...
<img src={{ URL::asset('/img/greenland/nbh/p1.png') }}>
<hr class="new1">
</div>
  <div class="w3-content w3-display-container" style="padding-top: 30px;">
  <img src={{ URL::asset('/img/greenland/nbh/p2.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p3.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p16.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p4.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p5.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p6.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p7.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p8.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p9.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p10.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p11.png') }}>
  <hr class="new1">
  <img ssrc={{ URL::asset('/img/greenland/nbh/p12.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/nbh/p15.png') }}>
 </div>
...
<a href="{{ asset('documents/greenland/nbh/Floorplan.pdf') }}" target="_blank">Building Map.pdf</a>
<br>
 <a href="{{ asset('documents/greenland/nbh/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
 <br>
 <a href="{{ asset('documents/greenland/nbh/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
   </div>

  <div id="Sreate Levy" class="w3-container city" style="display:none">
  <a href="{{ asset('documents/greenland/nbh/StrataLevy.pdf') }}" target="_blank">Strata Levy Estimate Summary.pdf</a>
  </div>
</div>
</div>
</div>
