...
<div class="w3-content w3-display-container" style="max-width:100%">
  ...
  <img class="mySlides" src={{ URL::asset('/img/greenland/lg/shot-02-balcony.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lg/shot-04-3bed-living.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lg/shot-05-penthouse-view(3).jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lg/shot-09-courtyard-north-FINAL.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lg/shot-14-kitchen-island-FINAL.jpg') }} style="width:100%">
...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Greenland: </span>LG-leichhardt green NSW</h1>



<div class="w3-content w3-display-container" style="padding-top: 60px;">
<img src={{ URL::asset('/img/greenland/lg/p1.png') }}>
<hr class="new1">
</div>
  <div class="w3-content w3-display-container" style="padding-top: 30px;">
  <img src={{ URL::asset('/img/greenland/lg/p2.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p3.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p4.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p5.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p6.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p7.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p8.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p9.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p10.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p11.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p12.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p13.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p14.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p15.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p16.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p17.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p18.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p19.png') }}>
    <hr class="new1">
    <img src={{ URL::asset('/img/greenland/lg/p20.png') }}>
	</div>
...
<div id="Floor Plan" class="w3-container city" style="display:none">
  <a href="{{ asset('documents/greenland/lg/Floorplates.pdf') }}" target="_blank">Building Map.pdf</a>
  <br>
  <a href="{{ asset('documents/greenland/lg/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
  <br>
  <a href="{{ asset('documents/greenland/lg/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
 </div>
<div id="Sreate Levy" class="w3-container city" style="display:none">
<a href="{{ asset('documents/greenland/lg/StrataLevy.pdf') }}" target="_blank">Strata Levy Estimate Summary.pdf</a>
  </div>
</div>
</div>
</div>
