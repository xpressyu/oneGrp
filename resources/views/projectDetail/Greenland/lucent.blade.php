...
<div class="w3-content w3-display-container" style="max-width:100%">
 ...
 <div class="imgRoll" style="padding-top:20px; width: 100%">
  ...
  <img class="mySlides" src={{ URL::asset('/img/greenland/lucent/T2.png') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lucent/T3.png') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/greenland/lucent/T4.png') }} style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Greenland: </span>lucent-North Sydney NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">The making of a masterpiece</h2>
                </div>
							</div>
						</div>
...
<img src={{ URL::asset('/img/greenland/lucent/p1.png') }}>
<hr class="new1">
</div>
  <div class="w3-content w3-display-container" style="padding-top: 30px;">
  <img src={{ URL::asset('/img/greenland/lucent/p2.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p3.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p4.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p5.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p6.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p7.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p8.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p9.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p10.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p11.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p12.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p13.png') }}>
  <hr class="new1">
  <img src={{ URL::asset('/img/greenland/lucent/p14.png') }}>
	</div>
