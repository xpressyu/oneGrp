...
<head>
<meta charset="UTF-8">
<title>Meriton-Escada,O'Riordan</title>
...
<h1>O'Riordan Mascot</h1>
<h2>Meriton-Escada</h2>
<img src={{ URL::asset('/img/meriton/escadaORiordan/meriton.png') }} style="width: 980px;">
<h2>Meriton</h2>
...
<div class="w3-content w3-display-container">
	<h3>MAKE YOURSELF AT HOME IN ESCADA</h3>
	<p class="text-justify">
<h4>Positioned less than 5km from Sydney</h4>
...
<div class="w3-content w3-display-container">
	...
	<br><br>
	<h3>SHOWCASING TRUE BOUTIQUE STYLE</h3>
<p class="text-justify">  This elegant building draws inspiration from the vibrant urban surrounds and the growing desire for luxurious, naturally-inspired living environments.
