...
<div class="imgRoll" style="padding-top:20px; width: 100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-01.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-02.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-03.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-04.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-05.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-06.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-07.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-08.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/ThePeninsula-externals-09.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/Kitchen.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/RhodesAerialImage-2-MiltonMoon.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/RiverviewInternals06Bedroom.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/Riverviewview.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/riverviewRhodes/Living.jpg') }} style="width:100%">
...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>RiverView-Rhodes NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;"> Riverview waterfront residences</h2> 
                </div>  
							</div>
						</div> 
...
<img src={{ URL::asset('/img/meriton/riverviewRhodes/page1.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/riverviewRhodes/page2.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/riverviewRhodes/page3.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/riverviewRhodes/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/riverviewRhodes/page5.png') }}>
	</div>
...
<a href="{{ asset('documents/meriton/riverviewRhodes/FloorPlan.pdf') }}" target="_blank">Building Map.pdf</a>
<br>
<a href="{{ asset('documents/meriton/riverviewRhodes/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
<br>
<a href="{{ asset('documents/meriton/riverviewRhodes/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
