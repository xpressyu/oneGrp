...
<h1 style="padding-left:25%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>Aqua-Rhodes NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">live life by the water</h2>
                </div>
							</div>
						</div>
...
<h3 style="font-family: Times New Roman; color: #1e3e49;">YOUR URBAN WATERFRONT OASIS</h3>
<p  class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">Reaching out to the waterfront, Aqua’s remarkable setting is inspirational whatever the time of year.
