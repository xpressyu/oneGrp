...
<div class="imgRoll" style="padding-top:20px; width: 100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_1999.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_2073(1).jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_2073.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_2080.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_2211.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/1920px_JJG_2229.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/Aerial_Web_900x600.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/BATHROOM-low-2.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/BEDROOM-low-2.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/Exterior5.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/GYM.jpg') }} style="width:100%">
     <img class="mySlides" src={{ URL::asset('/img/meriton/kiaraMascot/POOL.jpg') }} style="width:100%">
...
<h1 style="padding-left:25%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton:</span>Kiara-Mascot NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">1-5 kent rd mascot</h2> 
                </div>  
							</div>
						</div> 
...
<img src={{ URL::asset('/img/meriton/kiaraMascot/page2.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page3.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page5.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page6.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page7.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page8.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page9.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page10.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page11.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page12.png') }}>
<img src={{ URL::asset('/img/meriton/kiaraMascot/page13.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page14.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/kiaraMascot/page15.png') }}>
	</div>
...
<a href="{{ asset('documents/meriton/kiaraMascot/FloorPlan.pdf') }}" target="_blank">Building map.pdf</a>
  <br>
  <a href="{{ asset('documents/meriton/kiaraMascot/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
  <br>
  <a href="{{ asset('documents/meriton/kiaraMascot/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
</div>
</div>
</div>
</div>
