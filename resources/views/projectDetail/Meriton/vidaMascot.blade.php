...
<div class="w3-content w3-display-container" style="max-width:100%">
 ...
 <img class="mySlides" src={{ URL::asset('/img/meriton/vidaMascot/VIDA-ROOFTOP-LOW-RES-2-1024x683.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/vidaMascot/VIDA-BATHROOM-LOW-RES-1024x683.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/vidaMascot/extra.png') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/vidaMascot/MEG006-V03A-A-1024x683.jpg') }} style="width:100%">
...
<h1 style="padding-left:25%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>Vida-Mascot NSW</h1>
...
<img src={{ URL::asset('/img/meriton/vidaMascot/page1.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page2.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page3.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page5.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page6.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page7.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/vidaMascot/page8.png') }}>
...
<a href="{{ asset('documents/meriton/vidaMascot/FloorPlan.pdf') }}" target="_blank">Building Map.pdf</a>
<br>
  <a href="{{ asset('documents/meriton/vidaMascot/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
  <br>
  <a href="{{ asset('documents/meriton/vidaMascot/3Bed.pdf') }}" target="_blank">3 Bed.pdf</a>
