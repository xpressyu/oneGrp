...
<h3> PARRAMATTA’S TALLEST RESIDENTIAL TOWER</h3>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
   ...
   <li class="nav-item">
    <a class="nav-link" id="Strate-tab" data-toggle="tab" href="#Strate" role="tab" aria-contr ols="contact" aria-selected="false">Strata Levy</a>
  </li>
</ul>
