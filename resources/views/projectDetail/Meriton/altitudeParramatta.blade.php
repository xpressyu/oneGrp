...
<div class="imgRoll" style="padding-top:20px; width: 100%">
         ...
         <img  class="mySlides" src={{ URL::asset('/img/meriton/altitudeParramatta/AltitudeRetailRender.jpeg') }} style="width:100%">           <img  class="mySlides" src={{ URL::asset('/img/meriton/altitudeParramatta/AltitudeRiverbankRender.jpeg') }} style="width:100%">
...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>Altitude-Parramatta NSW</h1>

<section id="content">
	<div class="container">

						<div class="row" style="font-size: 18px; font-family: Times New Roman;color:#1e3e49; padding-left:10%">
							<div class="col-md-12">
								<div class="about-logo">
                  <h2 style="color: #1e3e49;">Altitude – directly on the banks of the Parramatta River</h2>
                </div>
							</div>
						</div>
...
<div class="right" style="width: 330px; padding-left: 30px;">
<h3 style="font-family: Times New Roman; color: #1e3e49;"> PARRAMATTA’S TALLEST RESIDENTIAL TOWER</h3>
