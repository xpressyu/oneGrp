...
<div class="imgRoll" style="padding-top:20px; width: 100%">
            ...
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Sales_Hero-image_1920x800_Lighthouse_7.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Sales_Hero-image_1920x800_Lighthouse_8.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Sales_Hero-image_1920x800_Lighthouse_11.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-Aerial_1920x800.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-bathroom_1920x800.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-Bedroom_1920x800.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-Cutaway_1920x800.jpg') }}style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-Dining_1920x800.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Lighthouse-living_1920x800.jpg') }} style="width:100%">
            <img class="mySlides" src={{ URL::asset('img/meriton/lighthouseDeeW/Sales_Hero-image_1920x800_Lighthouse_10.jpg') }} style="width:100%">
...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>lighthouse-Deewhy NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">DEE WHY’S NEW TOWN CENTRE</h2>
                </div>
							</div>
						</div>
...
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page2.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page3.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page5.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page6.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page7.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page8.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page9.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page10.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page11.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page12.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page13.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page14.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page15.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page16.png') }}>
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page17.png') }}>
<hr class="new1">
<img src={{ URL::asset('img/meriton/lighthouseDeeW/page18.png') }}>
</div>
...
<a href="{{ asset('documents/meriton/lighthouseDeeW/FloorPlan.pdf') }}" target="_blank">Building map.pdf</a>
<br>
<a href="{{ asset('documents/meriton/lighthouseDeeW/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
  <br>
  <a href="{{ asset('documents/meriton/lighthouseDeeW/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
</div>
</div>
</div>
</div>
