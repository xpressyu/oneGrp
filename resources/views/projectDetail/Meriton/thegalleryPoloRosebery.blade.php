...
<div class="w3-content w3-display-container" style="max-width:100%">
 ...
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/Phase3-TheGallery-Exterior-Edited.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/Kitchen-bronzemirror-.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/LivingRoom.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/PoloBathroom.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/pool.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/Terracesview2.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/Terraces.jpg') }} style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>The Gallery Polo-Rosebery NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">55 rothschild avenue rosebery </h2>
                </div>
							</div>
						</div>
...
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page3.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page5.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page6.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page7.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page8.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page9.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page10.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page11.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page12.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryPoloRosebery/page13.png') }}>
</div>
...
<br>
<a href="{{ asset('documents/meriton/thegalleryPoloRosebery/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
<br>
<a href="{{ asset('documents/meriton/thegalleryPoloRosebery/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
</div>
</div>
</div>
</div>
