...
<div class="w3-content w3-display-container" style="max-width:100%">
 ...
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/ElevatedExterior.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/BathroomDarkScheme.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/Bedroom.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/Kitchen-bronzemirror.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/LivingRoom.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/RetailExterior.jpg') }} style="width:100%">
 <img class="mySlides" src={{ URL::asset('/img/meriton/thegalleryRosebery/Pool.jpg') }} style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Meriton: </span>THE Gallery COCO-Rosebery NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">13 rosebery avenue rosebery</h2> 
                </div>  
							</div>
						</div> 
...
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page1.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page2.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page3.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page4.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page5.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page6.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page7.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page8.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page9.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page10.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page11.png') }}>
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page12.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page13.png') }}>
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page14.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/meriton/thegalleryRosebery/page15.png') }}>
<hr class="new1">
...
<br>
<a href="{{ asset('documents/meriton/thegalleryRosebery/1Bed.pdf') }}" target="_blank">1 Bed.pdf</a>
<br>
<a href="{{ asset('documents/meriton/thegalleryRosebery/2Bed.pdf') }}" target="_blank">2 Bed.pdf</a>
   </div>
</div>
</div>
</div>
