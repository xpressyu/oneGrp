...
<h1 style="padding-left:35%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">BM: </span>MelrosePark</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">The New HEART OF SYDNEY</h2>
                </div>
							</div>
						</div>
...
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">Melrose Park has been imagined for
...
<br>
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">The pulse of your new neighbourhood,
...
<br>
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">Inspired by the best parks around the world, abundant open
...
<br>
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">With the future in mind, Melrose Park takes an
...
<img src={{ URL::asset('/img/Bm/melroseParkTwo/p14-1.png') }}>
...
<div class="tab-content" id="myTabContent">
  ...
  <a href="{{ asset('documents/Bm/melroseParkTwo/FAQ.pdf') }}" target="_blank">FAQ.pdf</a>
  </div>
