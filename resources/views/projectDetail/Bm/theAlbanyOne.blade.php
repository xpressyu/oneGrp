...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">Luxury In The Making, Find Yourself At Home In The Village</h2> 
                </div>  
							</div>
						</div> 
...
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">Every aspect of The Albany tells a story of urban village living. A collaboration by Nettletontribe and Turner, the design is as individual and
...
<a href="{{ asset('documents/bm/theAlbanyOne/FAQ.pdf') }}" target="_blank">FAQ.pdf</a>
<br>
   </div>
</div>
</div>
