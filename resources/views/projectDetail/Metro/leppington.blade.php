...
<img class="mySlides" src="{{ URL::asset('/img/metro/leppington/CdHJGX8_.jpg') }}" style="width:100%">
<img class="mySlides" src="{{ URL::asset('/img/metro/leppington/QAPaVEXJ.jpg') }}" style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Metro: </span>Leppington  Living-Leppington NSW</h1>
<div class="w3-content w3-display-container" style="padding-top: 30px;">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 601 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p1.png') }}">
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 602/605 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p2.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 603/604 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p3.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 606 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p4.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 607 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p5.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 608/609 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p6.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 610 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p7.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 611 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p8.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 612/614 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p9.png') }}">
<hr class="new1">
<h3  style="font-family: Times New Roman; color: #1e3e49;">Lot 615 </h3>
<img src="{{ URL::asset('/img/metro/leppington/p10.png') }}">
		</div>
