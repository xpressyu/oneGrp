...
<div class="w3-content w3-display-container" style="max-width:100%">
 <div class="imgRoll" style="padding-top:20px; width: 100%">
  <img class="mySlides" src={{ URL::asset('/img/metro/theCCClaymore/I4uOQXOW.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/metro/theCCClaymore/J-ywgh6A.jpg') }} style="width:100%">
  <img class="mySlides" src={{ URL::asset('/img/metro/theCCClaymore/M679Gloq.jpg') }} style="width:100%">
...
<h1 style="padding-left:15%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Metro: </span>The Creation Collection-Claymore</h1>
<div class="w3-content w3-display-container" style="padding-top: 30px;">
<img src={{ URL::asset('/img/metro/theCCClaymore/map.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1008 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1008.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1009 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1009.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1010 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1010.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;" >Lot 1011</h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1011.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1012 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1012.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1013 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1013.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1014 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1014.png') }}>
<hr class="new1">
<h3 style="font-family: Times New Roman; color: #1e3e49;">Lot 1015 </h3>
<img src={{ URL::asset('/img/metro/theCCClaymore/Lot1015.png') }}>
<hr class="new1">
	</div>
...
<a href="{{ asset('documents/Metro/theCCClaymore/LOT1008.pdf') }}" target="_blank">LOT 1008.pdf</a>
   </div>
</div>
</div>
</div>
