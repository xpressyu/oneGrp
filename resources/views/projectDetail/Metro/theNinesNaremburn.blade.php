...
<h1 style="padding-left:20%; font-size: 48px; font-family: Times New Roman; color: #1e3e49; "> <span class="coloured">Metro: </span>TheNines-Naremburn NSW</h1>
...
<section id="content">
	<div class="container">
                  ...
                  <h2 style="color: #1e3e49;">a nod to heritage.an ode to tomorrow</h2>
                </div>
							</div>
						</div>
...
<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify  ; padding-top:20px;">A nod to heritage. An ode to tomorrow.Welcome to The Nines — where  the ordinary becomes extraordinary, and everyday life is richer than ever. A boutique collection of nine 3-storey residences, The Nines is perfected living for every generation.</p>
<hr class="new1">
<img src={{ URL::asset('/img/metro/theNinesNaremburn/p2.png') }}>
<hr class="new1">
<img src={{ URL::asset('/img/metro/theNinesNaremburn/p3.png') }}>

<p class="text-justify" style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;  padding-top:20px;">Welcome to your kitchen at The Nines —  a space that’s equal parts style and substance; form and function. Curated to the very last detail with space for the family to gather — this is where meals become memories.  </p>
<hr class="new1">
...
<a href="{{ asset('documents/Metro/theNinesNaremburn/TheNines_FINALfloorplans.pdf') }}" target="_blank">The Nines Fianl Floorplan.pdf</a>
  ...
  <a href="{{ asset('documents/Metro/theNinesNaremburn/FAQ-TheNinesNaremburn.pdf') }}" target="_blank">FAQ.pdf</a>
   </div>
