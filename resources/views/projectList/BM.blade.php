...
<div class="row" style="width:100%; padding-top: 50px;  padding-left: 100px">
          ...
          <a href="{{ route('melrosePark') }}">  <h2 style=" font-family: Times New Roman; color: #1e3e49;">Melrose Park</h2></a>
            <p style="font-family: Times New Roman; color: #1e3e49; text-align: justify ;">Celcbrating a multi-faceted and multi-cultural lifestyle, Melrose park will excite, inspire and connect.</p><br><br>
